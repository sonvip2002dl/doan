		...
		case 30:
		 {
		    ...
		    OLED_ShowString(20, 3, "test 1", 8);
		    OLED_ShowString(20, 4, "test 2", 8);
		    OLED_ShowString(20, 5, "openmv", 8);
			  OLED_ShowString(20, 6, "greySensor", 8);
		    OLED_ShowString(0, 3, ">>", 8);
		 }
		 break;
		 ...
		 /*********测试编码器是否正常**************/
//   		  OLED_ShowString(0, 0, "test 1:", 16);   //在test 1 里面调试获取编码器的数值
//		    sprintf((char *)str_buff1, "M_EncNum: %5d", M_EncNum);
//				sprintf((char *)str_buff2, "M_RNum:    %2.2f", M_EncNum*0.25/56/11);    //两相  上升沿下降沿都捕获 减速比1：56   单项编码器脉冲数11  
//				sprintf((char *)str_buff3, "M2_EncNum:%5d", M2_EncNum);  
//				sprintf((char *)str_buff4, "M2_RNum:   %2.2f", M2_EncNum*0.25/56/11);
//		 
...
//		    OLED_ShowString(0, 6,str_buff4, 8);
		 ...
		 case 132:
				...
				sprintf((char *)str_buff2, "LineNum:%d", Line_Num );
